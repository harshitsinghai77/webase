    ...
    <div style={{ flex: "1 1 0%", overflow: "auto" }}>
      <main>
        <div className={styles.root}>
          <h2 className={styles.pageHeader} style={{ marginTop: "24px" }}>
          ...
          <div className={styles.ModelForm_root__1FQzT}>
            ...
            <form className={styles.ModelForm_categoryForm__32uIx}>
              <input
                className={styles.ModelForm_labelInput__3jp9u}
                type="text"
                placeholder="Add categories here. For eg : dogs, cats"
              />
              <button
                className={styles.ModelForm_labelAdd__14SIj}
                type="submit"
                style={{ height: "100%", fontSize: "30px", padding: "0px" }}
              >
                +
              </button>
            </form>
            ...
            <div className={styles.ModelForm_categories__1DCHn}>
              <span className={styles.ModelForm_categoryWrapper__3qvMl}>
                <span className={styles.ModelForm_categoryName__3ikpG}>
                  dogs
                </span>
            ...
            <div className={styles.flexCenter} style={{ marginTop: "60px" }}>
              <button className={styles.drzUyi}>
