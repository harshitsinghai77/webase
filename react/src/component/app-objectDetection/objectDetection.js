...
function DataAnalysis(props) {
    ...
    React.useEffect(() => {
        ...
        const webcamPromise = navigator.mediaDevices.getUserMedia({video: true,audio: false,})
            .then(stream => {
    ...
    return (
        <div className = {styles.root_class}>
            ...
            <video
                ...
                height="600"
            />
            <canvas style ={{position: 'fixed', top:'100px', left: '300px'}} ref={canvasRef} width="720" height="650" />
        </div>
    )
}
